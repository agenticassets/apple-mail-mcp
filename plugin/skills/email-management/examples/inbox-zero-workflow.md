...
2. Export important mailboxes first: `export_emails(scope="entire_mailbox", mailbox="Important", max_emails=50)` (page with `offset` if the mailbox holds more than 50 messages)
