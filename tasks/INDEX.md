...
| [`active/native-reply/`](active/native-reply/) | Native-format reply drafts, including attachment preservation, fail-closed verification, foreground requirement, and typing-path timing | Attachment fix verified offline; disposable-fixture live matrix pending. 2026-08-24 live session added [`live-timing-and-frontmost-2026-08-24.md`](active/native-reply/live-timing-and-frontmost-2026-08-24.md): Mail-must-be-frontmost fix shipped and live-proven; a ~3,040-char timeout cliff and a root-caused `REPLY_BODY_MISMATCH` normalizer bug are open |
